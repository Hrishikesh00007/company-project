...
$arr[$i][3]=$fetchm['bname'];
$arr[$i][4]=$fetchm['accname'];
$arr[$i][5]=ucwords($fetchm['accno']);
$arr[$i][6]=ucwords($fetchm['ifscode']);
$i++;
}}

$name='bank-details-Statement-'.date('Y-m-d');
