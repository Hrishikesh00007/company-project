...
<h4 class="card-title">Cashback Level Bonus Statement</h4>
...
<div class="row">
<form name="frm1" method="post" action="commission-cashback-level.php?act=search">
...
<div class="col-md-2">
<div style="padding:5px;">
<div align="left" style="margin-left:10px;"><a href="commission-cashback-level-csv-download.php"><input type="button" value="Excel Download" class="btn" style="background:#009900;color:#FFFFFF;" /></a></div>
</div>
</div>
</div>
...
<?php
$tname='ee_commission_cashback_level';
$lim=100;
$tpage='commission-cashback-level.php';
...
$where="WHERE `date`<='".date('Y-m-d')."' ORDER BY `id` DESC";
}
...
<td align="center" style="padding:3px;"><?=getMemberName($conn,$fetch['fromid'],'name')?></td>


<td align="center" style="padding:3px;"><?=$fetch['level']?></td>
<td align="center" style="padding:3px;"><?=$fetch['cashback']?></td>


<td align="center" style="padding:3px;"><?=$fetch['bonusper']?></td>
