...
<div class="row">
<form name="frm1" method="post" action="commission-direct-bonus.php?act=search">
...
<div class="col-md-2">
<div style="padding:5px;">
<div align="left" style="margin-left:10px;"><a href="commission-direct-bonus-csv-download.php"><input type="button" value="Excel Download" class="btn" style="background:#009900;color:#FFFFFF;" /></a></div>
</div>
</div>
</div>
...
$lim=100;
$tpage='commission-direct-bonus.php';
...
<td align="center" style="padding:3px;"><?=$fetch['directper']?></td>
