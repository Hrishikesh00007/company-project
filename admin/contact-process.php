...
{
$sql1="INSERT INTO `ee_contact` (`title`,`addline1`,`addline2`,`email1`,`email2`,`phone1`,`phone2`,`date`) VALUES('".input($_POST['office'])."','".input($_POST['address1'])."','".input($_POST['address2'])."','".mysqli_real_escape_string($conn,input($_POST['email1']))."','".mysqli_real_escape_string($conn,input($_POST['email2']))."','".mysqli_real_escape_string($conn,input($_POST['phone1']))."','".mysqli_real_escape_string($conn,input($_POST['phone2']))."','".date('Y-m-d')."')";
