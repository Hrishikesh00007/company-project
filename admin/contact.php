...
<div class="form-group">
<label for="userinput5">Address Line1<span style="color:#CC0000;">*</span></label>
<input  class="form-control border-primary" type="text" placeholder="Enter Address Line1" id="address1" name="address1" value="" required >
</div>

<div class="form-group">
<label for="userinput5">Address Line2 </label>
<input  class="form-control border-primary" type="text" placeholder="Enter Address Line2"  id="address2" name="address2" value="" >
</div>

<div class="form-group">
<label for="userinput5">Email1<span style="color:#CC0000;">*</span></label></label>
<input  class="form-control border-primary" type="email" placeholder="Enter Email1"  id="email1" name="email1" value="" required>
</div>
...
<div class="form-group">
<label for="userinput5">Phone1<span style="color:#CC0000;">*</span></label></label>
<input class="form-control border-primary" type="text" placeholder="Enter Phone1" id="phone1" name="phone1" value="" required />
</div>
<div class="form-group">
<label for="userinput5">Phone2</label>
<input class="form-control border-primary" type="text" placeholder="Enter Phone2" id="phone2" name="phone2" value="" />
</div>
...
<div class="form-group">
<label for="userinput5">Address Line1<span style="color:#CC0000;">*</span></label>
<input class="form-control border-primary" type="text" placeholder="Enter Address Line1" id="address1" name="address1" value="<?=$fetch['addline1']?>"  required >
</div>
<div class="form-group">
<label for="userinput5">Address Line2</label>
<input class="form-control border-primary" type="text" placeholder="Enter Address Line2"  id="address2" name="address2" value="<?=$fetch['addline2']?>">
</div>

<div class="form-group">
<label for="userinput5">Phone1<span style="color:#CC0000;">*</span></label>
<input class="form-control border-primary" type="text" placeholder="Enter Phone1" id="phone1" name="phone1" value="<?=$fetch['phone1']?>" required/>
</div>
<div class="form-group">
<label for="userinput5">Phone2</label>
<input class="form-control border-primary" type="text" placeholder="Enter Phone2"  id="phone2" name="phone2" value="<?=$fetch['phone2']?>" />
</div>


<div class="form-group">
<label for="userinput5">Email1<span style="color:#CC0000;">*</span></label>
<input class="form-control border-primary" type="email" placeholder="Enter Email1" id="email1" name="email1" value="<?=$fetch['email1']?>" required>
</div>
<div class="form-group">
<label for="userinput5">Email2</label>
...
<th style="text-align:center;" width="10%">Address_Line1</th>
<th style="text-align:center;" width="10%">Address_Line2</th>
...
<td align="center"><?=output($fetch['title'])?></td>
<td align="center"><?=output($fetch['addline1'])?></td>
<td align="center"><?=output($fetch['addline2'])?></td>
<td align="center"><?=output($fetch['phone1'])?></td>
<td align="center"><?=output($fetch['phone2'])?></td>
<td align="center"><?=output($fetch['email1'])?></td>
<td align="center"><?=output($fetch['email2'])?></td>
<td align="center">
