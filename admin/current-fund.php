...
<div class="row">
<form name="frm1" method="post" action="current-fund.php?act=search">
...
<div class="col-md-2">
<div style="padding:5px;">
<div align="left" style="margin-left:10px;"><a href="current-fund-csv-download.php"><input type="button" value="Excel Download" class="btn" style="background:#009900;color:#FFFFFF;" /></a></div>
</div>
</div>
</div>
...
<th width="15%" align="center">Current</th>
<th width="15%" align="center">Charge</th>
