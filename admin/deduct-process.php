...
if($_POST['amount']>0)
{
$sql1="INSERT INTO `ee_deduct`(`userid`,`wallet`,`amount`,`remarks`,`date`) VALUES('".trim($_POST['userid'])."','".trim($_POST['wallet'])."','".trim($_POST['amount'])."','".addslashes($_POST['remarks'])."','".date('Y-m-d')."')";
$res1=query($conn,$sql1);   
