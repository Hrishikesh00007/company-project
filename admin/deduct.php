...
<?php if(isset($_REQUEST['m'])==1){?><p align="center" style="color:#00CC33; padding-bottom:8px;">Deduct Successfully!!</p><?php }?>
...
<div align="left" style="padding:5px;"><a href="deduct-csv-download.php"><input type="button" value="Excel Download" class="btn" style="background:#009900;color:#FFFFFF; width:100%;margin-top:10px; margin-bottom:5px;" /></a></div>
</div>

<div class="col-xs-12 col-sm-2">
<div align="right" style="padding:5px;">
<form name="frm1" method="post" action="deduct.php?act=search">
<input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="margin-top:5px;  margin-bottom:5px;" />
</form>
</div>
</div>
