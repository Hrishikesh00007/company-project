...
<tr><td width="33%">User ID</td><td width="67%"><?=$fetch['userid']?></td></tr>
...
<tr><td>Address</td><td><?=ucwords($fetch['address'])?></td></tr>
<tr><td>Status</td><td><?php if($fetch['status']=='A'){?><span style="color:#009900;">Active</span><?php }else{?><span style="color:#FF0000;">Inactive</span><?php }?></td></tr>
<tr><td>Pay Status</td><td><?php if($fetch['paystatus']=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td></tr>
...
?>
<table width="95%" class="table table-striped table-bordered table-hover" id="sample_1">
<tr><td width="33%">Bank</td><td width="67%"><?=$fetch['bname']?></td></tr>
<tr><td width="33%">Account Holder Name</td><td width="67%"><?=$fetch['accname']?></td></tr>
<tr><td width="33%">Account No.</td><td width="67%"><?=$fetch['accno']?></td></tr>
<tr><td width="33%">IFSC Code</td><td width="67%"><?=$fetch['ifscode']?></td></tr>
<tr><td width="33%">UPI ID</td><td width="67%"><?=$fetch['upiid']?></td></tr>
</table>
<?php }?>
</div>
</div>
