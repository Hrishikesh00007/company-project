...
<td style="padding:3px;"><?=ucwords($fetch['name'])?></td>
<td style="padding:3px;"><?=$fetch['email']?></td>
<td style="padding:3px;"><?=$fetch['phone']?></td>
<td style="padding:3px;"><?=ucwords($fetch['subject'])?></td>
<td style="padding:3px;"><?=ucwords(substr($fetch['message'],0,50))?>...</td>
<td style="padding:3px;"><?=$fetch['date']?></td>
