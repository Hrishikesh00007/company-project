...
<li class="nav-item"><a href="dashboard.php" class="navbar-brand nav-link">
<img alt="<?=$title?>" src="images/logo.png" data-expand="images/logo.png"  style="color:#FFFFFF" class="brand-logo" width="140"></a></li>
...
<ul class="nav navbar-nav">
<li class="nav-item hidden-sm-down"><a class="nav-link nav-menu-main menu-toggle hidden-xs"><i class="icon-menu5" style="color:;">         
</i>
</a>
</li>
