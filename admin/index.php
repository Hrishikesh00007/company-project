...
<link rel="stylesheet" type="text/css" href="app-assets/css/colocss">
<!-- END ROBUST CSS-->
...
<div class="card-header no-border"  style=" background-color:#000 ;">
<div class="card-title text-xs-center">
<div class="p-1" align="center"><h2 style="color:#000099;" align="center"><img src="images/logo.png" width="250" alt="Purely trading"/></h2>
</div>
</div>
<h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span style="font-size:18px; background-color:#000000; color:#FFFFFF;"><?=$title?></span></h6>
</div>
