...
<table width="100%">
<tr><td>
<div align="left" style="margin-left:10px;"><a href="member-topup-csv-download.php"><input type="button" value="Excel Download" class="btn" style="background:#009900;color:#FFFFFF;" /></a></div>
</td>
<td>
<div align="right" style="padding:10px;">
<form name="form3" action="member-topup-statement.php?act=search" method="post">
...
<th style="text-align:center;">Topup_ID</th>
<th style="text-align:center;">Name</th>
