...
<h4 class="card-title">Member Upgrade Statement</h4>
...
<div align="right" style="padding:5px;"><form name="frm1" method="post" action="member-upgrade.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:150px;" />
</form></div>
...
<td align="center" style="padding:3px;"><?=$fetch['epin']?></td>
