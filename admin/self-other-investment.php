...
<h4 class="card-title">Others Investment Statement</h4>
...
<div class="row">
<form action="self-other-investment.php?act=search" method="post">
...
<div class="col-md-2">
<div style="padding:5px;">
<div align="left" style="margin-left:10px;"><a href="self-other-investment-csv-download.php"><input type="button" value="Excel Download" class="btn" style="background:#009900;color:#FFFFFF;" /></a></div>
</div>
</div>
</div>
...
<tr align="center">
<th width="6%">Sl_No.</th>
<th width="12%">User_ID</th>
<th width="12%">Name</th>		
<th width="12%">To_User_ID</th>	
<th width="12%">Name</th>										
...
<?php
$tname='ee_member_investment_others';
$lim=100;
$tpage='self-other-investment.php';
...
<td style="text-align:center;padding:2px;"><?=$fetch['toid']?></td>
<td style="text-align:center;padding:2px;"><?=getMemberName($conn,$fetch['toid'],'name')?></td>
