...
<?php 
$sql="SELECT * FROM `ee_settings_onoff` WHERE `id`='".trim($_REQUEST['id'])."'";
$res=query($conn,$sql);
$num=numrows($res);
if($num>0)
{
...
<td align="center" style="padding:3px;"><?php if($fetch['withdrawal']=='A'){?>ON<?php }else{?>OFF<?php }?></td>
