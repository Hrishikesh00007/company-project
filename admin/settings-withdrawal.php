...
<?php 
$sql="SELECT * FROM `ee_settings_withdrawal` WHERE `id`='".trim($_REQUEST['id'])."'";
$res=query($conn,$sql);
$num=numrows($res);
if($num>0)
{
...
<div class="form-group">
<label for="userinput5">Service (%)<b style="color:#FF0000;">*</b></label>
...
<td style="text-align:center;"><?=$fetch['service']?> %</td>
<td align="center"><a href="settings-withdrawal.php?case=edit&id=<?=$fetch['id']?>" onClick="return confirm('Are you sure want to edit?');"><img src="images/edit.png" /></a></td>
</tr>
<?php $i++;}}else{?>
