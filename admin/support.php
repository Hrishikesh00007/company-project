...
<td align="center" style="padding:2px;"><?=ucwords($fetch['message'])?></td>
<td align="center" style="padding:2px;"><?php if($fetch['reply']){?><?=ucwords($fetch['reply'])?><?php }else{?><a href="reply.php?id=<?=$fetch['id']?>">Reply</a><?php }?></td>
