...
{
$sqlp="SELECT * FROM `ee_member` WHERE `userid`='".mysqli_real_escape_string($conn,trim($_POST['userid']))."' AND `email`='".mysqli_real_escape_string($conn,trim($_POST['email']))."' AND `status`='A'";
