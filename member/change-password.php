...
<label for="pillInput"><strong style="color:#000;">Current Password</strong><span style="color:#FF0000;">*</span></label>
<input type="password" class="form-control input-pill" id="current" name="current" placeholder="Current Password" required>
</div>

<div class="form-group">
<label for="pillInput"><strong style="color:#000;">New Password</strong><span style="color:#FF0000;">*</span></label>
<input type="password" class="form-control input-pill" id="newpass" name="newpass" placeholder="New Password" required>
</div>

<div class="form-group">
<label for="pillInput"><strong style="color:#000;">Confirm Password</strong><span style="color:#FF0000;">*</span></label>
