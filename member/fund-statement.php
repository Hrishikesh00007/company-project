...
<div class="card-title">Fund Transfer Statement</div>
</div>
...
?>
<tr>
<td align="center" style="color:#000033"><?=$i?></th>
<td align="center" style="color:#000033"><?=$fetch['toid']?></td>
<td align="center" style="color:#000033"><?=getMemberUserid($conn,$fetch['toid'],'name')?></td>
<td align="center" style="color:#000033"><?=$fetch['fund']?></td>
<td align="center" style="color:#000033"><?=$fetch['remarks']?></td>
...
<tr>
<td align="center" style="color:#000033"><?=$i?></th>
<td align="center" style="color:#000033"><?=$fetch['userid']?></td>
<td align="center" style="color:#000033"><?=getMemberUserid($conn,$fetch['userid'],'name')?></td>
<td align="center" style="color:#000033"><?=$fetch['fund']?></td>
<td align="center" style="color:#000033"><?=$fetch['remarks']?></td>
<td align="center" style="color:#000033"><?=getDateConvert($fetch['date'])?></td>
</tr>
...
<div class="card-header">
<div class="card-title">Fund Received From Administrator</div>
</div>
<div class="card-body" style="overflow:auto;background:#FFFFFF;">
