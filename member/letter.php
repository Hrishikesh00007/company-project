...
<div class="card-body" style="background:#FFFFFF;overflow:auto;">

<p align="right"><a onClick="printDivList();" style="cursor:pointer;"> <img src="print.png" title="Print Letter" /></a></p>
<div id="printdiv" >
<div style="border:1px solid #000000;padding:10px;width:100%;min-height:650px;overflow:auto;">
...
<td align="center" valign="middle" style="font-size:22px;margin-top:40px;color:#000099"><strong><?=$title?></strong></td></tr>
<tr><td height="37" align="left" valign="middle" style="font-size:18px;"><strong>Welcome TO <?=$title?></strong></td>
</tr>
...
<td><?=getSettingsPackage($conn,getMember($conn,$_SESSION['mid'],'package'),'package')?></td>
...
As a member of <?=$title?>. You shall avall all the facilities and services provided by the Company. To track your ID please visit <a href="https://<?=$domain?>" target="_blank"><?=$domain?></a>
<div>&nbsp;</div></td>
</tr>
<tr>
