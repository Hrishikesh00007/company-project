...
$lim=100;
$tpage='member-service-statement.php';
...
<td align="center" style="color:#000033"><?php if($fetch['status']=='P'){?><span style="color:#FF0000">Pending</span><?php }else{?><span style="color:#00CC00">Approved</span><?php }?></td>

<td align="center" style="color:#000033"><?=$fetch['date']?></td>
<td align="center" style="color:#000033"><?=$fetch['approved']?></td>
