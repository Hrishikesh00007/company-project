...
<?php
$sql2="SELECT * FROM `ee_settings_package` WHERE `package`>(SELECT `pvalue` FROM `true_member_package` WHERE `userid`='".$userid."' ORDER BY `pvalue` DESC LIMIT 1 ) ORDER BY `package`";
