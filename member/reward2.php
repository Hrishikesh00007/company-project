...
<div class="card-title">Reward 2 Statement</div>
</div>
<div class="card-body" style="overflow:auto;background:#4b4374;">
...
<td align="center" style="padding:3px;"><?=$fetch['nodirect']?></td>
<td align="center" style="padding:3px;"><?=$fetch['withindays']?></td>
